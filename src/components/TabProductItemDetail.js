                ...
                <div className="tab-content">
                    ...
                    <div id="Reviews" className="container tab-pane fade"><br />
                        ...
                        <div className="form-group">
                            ...
                            <textarea className="form-control" rows={5} id="review" defaultValue={""} />
                        </div>
                        <div className="row">
                            <div className="form-group col-12 col-md-6">
                                <label htmlFor="name">Name *</label>
                                <textarea className="form-control" rows={5} id="name" defaultValue={""} />
                            </div>
                            <div className="form-group col-12 col-md-6">
                                <label htmlFor="email">Email *</label>
                                <textarea className="form-control" rows={5} id="email" defaultValue={""} />
                            </div>
                        </div>
